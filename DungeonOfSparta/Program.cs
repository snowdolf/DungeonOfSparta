public partial class GameManager
{
    ...
    private void InitializeGame()
    {
        ...
        storeInventory.Add(new Item("무쇠 투구", "튼튼한 투구", ItemType.HELMET, 0, 10, 0, 2000));

        storeInventory.Add(new Item("수련자 갑옷", "쓸만한 갑옷", ItemType.BODYARMOUR, 0, 10, 0, 2000));
        storeInventory.Add(new Item("무쇠 갑옷", "튼튼한 갑옷", ItemType.BODYARMOUR, 0, 20, 0, 4000));

        storeInventory.Add(new Item("수련자 장갑", "쓸만한 장갑", ItemType.GLOVE, 0, 5, 0, 1000));
        storeInventory.Add(new Item("무쇠 장갑", "튼튼한 장갑", ItemType.GLOVE, 0, 10, 0, 2000));

        storeInventory.Add(new Item("수련자 장화", "쓸만한 장화", ItemType.BOOT, 0, 5, 0, 1000));
        storeInventory.Add(new Item("무쇠 장화", "튼튼한 장화", ItemType.BOOT, 0, 10, 0, 2000));
    }
